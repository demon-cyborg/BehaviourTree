...
/**
        private Root HitAndRun()
        {
            return new Root(
                //prioritise escaping over attacking
                new Service(0.01f, UpdatePerception,
                    new Selector(
                        //check proximity, decide to flee
                        new BlackboardCondition("targetDistance", Operator.IS_SMALLER_OR_EQUAL, 1.5f, Stops.IMMEDIATE_RESTART,
